...
@Path("/zoom")
public class ZoomImagemNormalResource {
    @GET
    @Produces("text/html")
    public String Zoom() {
        String html,img,parametros;
        img = SelecionarFiltroResource.ImagemGlobal;
        parametros = ResultadoDaEscolhaResource.filtroGlobal;
        ...
        html += "<img src=\""+img+"\"width=\"850px\" height=\"510px\">";
        html += "<p><a href=\"resultadodaescolha?tipoFiltro="+parametros+"\">Voltar</a></p>";
        html += "</body></html>";
        return html;
    }
}